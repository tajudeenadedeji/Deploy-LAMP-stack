...
<VirtualHost *:80>
    ServerAdmin tajudeenadedejir2@gmail.com
    ServerName 192.168.56.59
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=deji/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=deji/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=deji20/' /var/www/html/laravel/.env
